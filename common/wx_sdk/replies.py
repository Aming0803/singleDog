...
class ArticleReply(WXChatReply):
    TEMPLATE = u"""
    <xml>
    <ToUserName><![CDATA[{target}]]></ToUserName>
    <FromUserName><![CDATA[{source}]]></FromUserName>
...
class GroupTransferReply(WXChatReply):
    """
    客服群发转发消息
    """
    TEMPLATE = u"""
